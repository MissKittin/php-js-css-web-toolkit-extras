function melinskrypt(element, words=['elo', 'benc', 'kurwa', 'ogunie', 'awizisie', 'tego typu', 'akat'])
{
	/*
	 * Melinskrypt
	...
	function przelec(a)
	{
		if((typeof a == 'object') && (typeof a.childNodes == 'object'))
			for(
				var b=a.childNodes,
					c=0;
				c < b.length;
				...
				if((d.nodeType == 1) && (d.tagName != 'SCRIPT') && (d.tagName != 'IFRAME') && (d.tagName != 'PRE'))
					przelec(d);
